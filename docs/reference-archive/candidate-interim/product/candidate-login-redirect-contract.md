...
This document records a superseded pre-cleanroom login direction. It does not govern current V2 implementation; use [Authenticated Candidate Access](../../../02-requirements/authenticated-candidate-access.md).

Date: 2026-05-08
Original status: Integration contract needed
