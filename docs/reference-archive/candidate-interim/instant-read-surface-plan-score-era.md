...
Original status: Retired score-era reference
Last updated: 2026-07-24

This plan predates the evidence-first V2 evaluator and dashboard contract. Its
numeric score rollups, `overallRead`, and legacy/scoreless compatibility
fallbacks are retired and must not be reintroduced. The governing direction is
the ratified Evidence-First Dashboard Information Architecture and ADR-0010.
