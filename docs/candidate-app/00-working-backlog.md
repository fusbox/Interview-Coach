...
| DASH-S20 | TBD | Story | New | Fu Chen <fu@rangam.com> | Clarify Question Mix chart semantics | Dashboard Quick View Question Mix uses planned category distribution as the total pie shape, separates practiced and upcoming arcs, and applies preparedness-state color only where scored practice evidence exists |
