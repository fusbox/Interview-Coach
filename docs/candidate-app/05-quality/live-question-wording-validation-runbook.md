...
5. `CANDIDATE_QUESTION_WORDING_PROFILE=google_gemini_2_5_flash_question_wording_v1`;
...
$env:CANDIDATE_QUESTION_WORDING_PROFILE="google_gemini_2_5_flash_question_wording_v1"
