...
- Latest reviewed head before this slice: `b7756a2 feat: add app auth middleware guard`
- Date: initial inventory 2026-05-04; refreshed 2026-05-06 after porting AI-quality generation capture, browser profile/auth client cleanup, API-route auth seam work, server-page profile lookup cleanup, app-auth middleware protected-page redirects, and app-user provisioning.
