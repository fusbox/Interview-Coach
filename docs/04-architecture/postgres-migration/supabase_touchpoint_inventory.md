...
- Latest reviewed head before this slice: `a5b29ea docs: refresh postgres migration context`
- Date: initial inventory 2026-05-04; refreshed 2026-05-05 after porting AI-quality generation capture, browser profile/auth client cleanup, API-route auth seam work, and server-page profile lookup cleanup.
