                ...
                <div className="mx-auto w-full max-w-7xl space-y-8 px-6 py-12 md:px-10 md:py-16">
                    <div className="space-y-4">
                        ...
                        <p className="pl-4 text-lg leading-8 text-text-secondary">
                            This practice is designed to help you understand what a question is really testing, shape a
                            stronger response, and leave with useful guidance instead of a pass-or-fail label.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-5 md:grid-cols-2">
                        <div className="border-t border-border pt-5">
                            ...
                            <p className="mt-3 text-sm leading-7 text-text-secondary">
                                The coach is designed to understand what each question is really testing, so it can help
                                you respond with stronger examples, clearer structure, and better judgment.
                            </p>
                        </div>
                        <div className="border-t border-border pt-5">
                            <div className="flex items-center gap-3 text-primary">
                            ...
                            <p className="mt-3 text-sm leading-7 text-text-secondary">
                                You should leave understanding what helped, what weakened the answer, and what to
                                practice next, without being reduced to a label.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-12 md:px-10 md:py-16">
                    <div className="space-y-4">
                        <div className="flex items-stretch gap-3">
                            <div className="w-1 shrink-0 rounded-full bg-primary" />
                            <h2 className="font-display text-4xl font-bold leading-tight text-text-primary md:text-5xl">
                                A dashboard that keeps the next practice step{" "}
                                <span className="text-primary">clear.</span>
                            </h2>
                        </div>
                        <p className="pl-4 text-lg leading-8 text-text-secondary">
                            Your dashboard should make it easy to return, review what changed, and decide what kind of
                            practice will help most next.
                        </p>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-stretch gap-3">
                                ...
                                <h2 className="font-display text-4xl font-bold leading-tight text-text-primary md:text-5xl">
                                    ...
                                    <span className="text-primary">that you control.</span>
                                </h2>
                            </div>
                            <p className="pl-4 text-lg leading-8 text-text-secondary">
